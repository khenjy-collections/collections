              ...
              <div class="col-lg-3">
                <div class="card" style="width: 100%; height: 100%">
                  ...
                  <div class="card-body mt-3">
                    <label for="image">Ganti Gambar Karyawan</label>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="e_birth_date" class="col-form-label">Data Kelahiran Karyawan</label>
                          <div class="col-lg p-0">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="e_hire_date" class="col-form-label">Tanggal Mulai Kerja</label>
                          <div class="col-lg p-0">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label for="s_id" class="col-form-label">Jam Kerja</label>
                    ...
                    <button type="submit" class="btn btn-success btn-icon-split mt-4 float-right">
                      ...
                      <span class="text">Simpan Edit</span>
                    </button>
                  </div>
                </div>
              </div>
