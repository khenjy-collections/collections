        ...
        <div class="container-fluid">
          ...
          <form action="" method="POST" class="col-lg-5  p-0">
            <div class="card">
              <h5 class="card-header">Tambah Jam Kerja</h5>
              <div class="card-body">

                <div class="form-group row">
                  <label class="col-sm-4 col-form-label col-form-label-lg">Nomor jam kerja</label>
                  <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label for="s_start_h" class="col-form-label-lg">Mulai jam kerja</label>
                  <div class="row">
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label for="s_end_h" class="col-form-label-lg">Akhir jam kerja</label>
                  <div class="row">
                    <div class="col-sm-4">
