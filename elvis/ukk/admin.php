<?php
session_start();
if (!isset($_SESSION['lv']) == "administrator") {
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="admin.php?page=datakos">Data Kos</a>
                                <a class="nav-link" href="admin.php?page=databkategori">Data Kategori</a>
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        switch ($page) {
                            ...
                            case 'datauser':
                                ...
                                break;
                            case 'inputkos':
                                include "inputkos.php";
                                break;
                            case 'inputkategori':
                                include "inputkategori.php";
                                break;
                            case 'edit_b':
                                include "edit_kos.php";
                                break;
                            case 'del_b':
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; FKOM 2023</div>
                        <div>
